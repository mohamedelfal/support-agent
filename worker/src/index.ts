/**
 * ============================================================
 * وكيل دعم عملاء - النسخة المستقرة المحسّنة
 * تعتمد على D1 لإدارة المحادثات و AI.run للأسئلة العامة
 * تحتوي على: نظام جلسات، تأكيدات، تذاكر، تحديث بريد، تتبع طلب
 * ============================================================
 */
